  ...
  try {
    ...
    await client.query(`
      ...
      CREATE TABLE IF NOT EXISTS public.members (
        ...
        roles TEXT[] DEFAULT '{ROLE_USER}' -- 다중 권한 지원을 위한 배열 컬럼 추가
      );
      ...
      -- 11. RTU 수신 로그 (TimescaleDB 하이퍼테이블 대상)
