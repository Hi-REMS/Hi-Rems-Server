...
const initPostgres = async () => {
  ...
  try {
    ...
    await client.query(`
      ...
      CREATE TABLE IF NOT EXISTS public.remssendlog (
        id BIGSERIAL,
        time TIMESTAMP WITH TIME ZONE NOT NULL,
        "rtuImei" CHARACTER VARYING(23) NOT NULL,
        "msgType" CHARACTER VARYING(1),
        cmd CHARACTER VARYING(10),
        body TEXT,
    ...
    try {
      ...
      await client.query(`SELECT create_hypertable('public.remssendlog', 'time', if_not_exists => TRUE);`);
      console.log('하이퍼테이블 설정 완료 (log_rtureceivelog, remssendlog).');
    } catch (e) {
      console.log('하이퍼테이블 설정 건너뜜 (이미 존재함).');
    }
